...
PATTERNS = [
    ...
    {"regex": r"(fish|shrimp|salmon|tilapia)\s+harvest(ing)?", "alternative": "slaughter", "reason": "Aquaculture euphemism for killing/slaughtering farmed fish/shrimp. 'Harvest' obscures the mass killing at the end of the grow-out phase."},
    {"regex": r"stocking\s+densit(?:y|ies)", "alternative": "crowding density", "reason": "Industry term for extreme overcrowding in aquaculture tanks/ponds/net pens, where fish are packed at densities causing stress, disease, and cannibalism."},
    ...
    {"regex": r"grow-out\s+(pond|tank|phase)", "alternative": "fattening facility", "reason": "Final fattening phase before slaughter in aquaculture."},
]
